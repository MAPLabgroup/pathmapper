...
if nargin<2
    ...
    xmax=min([xmax+5;xylim(3:4)]); %hard code the larger scale than the input data, as opposed to the scale dynamically changing with the height of the input data
    xmin=max([xmin-5;xylim(1:2)]);
